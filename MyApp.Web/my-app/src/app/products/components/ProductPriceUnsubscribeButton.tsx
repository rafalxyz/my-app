...
export const ProductPriceUnsubscribeButton = ({ subscriptionId }: { subscriptionId: string }) => {
  ...
  const handleClick = async () => {
    apiDelete('subscriptions', { id: subscriptionId }, {
      onSuccess: () => {
  ...
  return (
      <> 
         <Button variant="outlined" color="primary" aria-label="create" onClick={() => handleClick()}>
