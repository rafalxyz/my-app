...
import { Form, SaveButton, TextInput, useCreate, useNotify, email } from 'react-admin';
import { FieldValues } from 'react-hook-form';
import usePriceSubscriptions from '../hooks/usePriceSubscription';


export const ProductPriceSubscribeButton = ({ productId }: { productId: string }) => {
  ...
  const handleSubmit = async (values: FieldValues) => {
    create('subscriptions', { data: { productId, ...values } }, {
           ...
           >
               ...
               <DialogContent>
                 <Form record={{ email: '' }} onSubmit={handleSubmit}>
                  <TextInput source="email" validate={email('Provide a valid email.')} fullWidth />
